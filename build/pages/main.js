        ...
        <section class="bio">
          <div class="bio-content">
            ...
            <div class="button-holder">
              <a class="content-button" href="./resume1.pdf">Résumé</a>
              <a class="content-button" href="#" id="contactLink2">Contact</a>
            </div>
          </div>
          <img class="portrait-image" src="../assets/images/me and wife.jpg">
        </section>
        <section >
